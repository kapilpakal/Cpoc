...
int main()
{
    ...
    */
    ...
    int client;
    int portNum = 2000; // NOTE that the port number is same for both client and server
    bool isExit = false;
    int bufsize = 1024;
    char buffer[bufsize];
    char* ip = "127.0.0.1";
    ...
    */
    ...
    cout <<"For Deleteing the file press 1," <<endl;
    cout <<"For Copying the file press 2," <<endl;
    //My delete,copy and traversal code should be here
    int user_in;
    ...
    cin >> user_in; // 
        switch(user_in) {
         case 1:
          Delete(); //this is the function to delete the file.
        break;
         case 2:
           copy();//this is the function to copy the file.
          break;
      default:
        cout<< "wrong input" ;
    }
